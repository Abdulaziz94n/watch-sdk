 ...
 * 也不支持读取操作。
 */
open class BleSchedule: BleIdObject {
    ...
    public var mAdvance: Int = 0 // 提前提醒分钟数, 0 ~ 0xffff
    ...
    public init(_ year: Int, _ month: Int, _ day: Int, _ hour: Int, _ minute: Int,
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleSchedule{
