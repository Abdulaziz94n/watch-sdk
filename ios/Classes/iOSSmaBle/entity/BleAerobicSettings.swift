...
open class BleAerobicSettings: BleWritable {
    override var mLengthToWrite: Int {
        BleAerobicSettings.ITEM_LENGTH
    }
    
    static let ITEM_LENGTH = 9
    public var mHour :Int = 0 // 0-23
    public var mMin: Int = 0 //0-59
    public var mHRMin :Int = 0 // hr min
    public var mHRMax: Int = 0 //hr max
    public var mHRMinTime :Int = 0 // 1-30
    public var mHRMinVibration: Int = 0 //1-4
    public var mHRMaxTime :Int = 0 // 1-30
    public var mHRMaxVibration: Int = 0 //1-4
    public var mHRIntermediate :Int = 0 // 1-30
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleAerobicSettings{
