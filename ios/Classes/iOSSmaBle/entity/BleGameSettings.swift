...
open class BleGameSettings: BleWritable {
    static let ITEM_LENGTH = 9
    override var mLengthToWrite: Int {
        BleGameSettings.ITEM_LENGTH
    }
    public var mEnabled : Int = 0
    public var mStartHour1 : Int = 0
    public var mStartMinute1 : Int = 0
    public var mEndHour1 : Int = 0
    public var mEndMinute1 : Int = 0
    public var mStartHour2 : Int = 0
    public var mStartMinute2 : Int = 0
    public var mEndHour2 : Int = 0
    public var mEndMinute2 : Int = 0
