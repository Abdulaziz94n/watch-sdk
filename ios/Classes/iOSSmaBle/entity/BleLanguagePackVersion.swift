...
open class BleLanguagePackVersion: BleReadable {
    public var mVersion = "0.0.0"
    public var mLanguageCode = Languages.DEFAULT_CODE
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleLanguagePackVersion{
