...
open class BleMedicationAlarm: BleIdObject {
    ...
    public var mEnabled = 1
    public var mRepeat = 0
    public var mYear = 2000
    public var mMonth = 1
    public var mDay = 1
    public var mHour = 0
    public var mMinute = 0

    required public init(_ data: Data? = nil, _ byteOrder: ByteOrder = .BIG_ENDIAN) {
        super.init(data, byteOrder)
    }

    public init(_ enabled: Int = 1, _ repeat: Int = 0, _ year: Int = 2000, _ month: Int = 1, _ day: Int = 1, _ hour: Int = 0, _ minute: Int = 0) {
        super.init()
        mEnabled = enabled
        mRepeat = `repeat`
        mYear = year
