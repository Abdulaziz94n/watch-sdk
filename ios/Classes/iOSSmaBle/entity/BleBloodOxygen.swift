...
open class BleBloodOxygen: BleReadable {
    static let ITEM_LENGTH = 6
    
    @objc public var mTime: Int = 0 // 距离当地2000/1/1 00:00:00的秒数
    @objc public var mValue: Int = 0 //血氧值
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleBloodOxygen{
