...
open class BleAlarm: BleIdObject {
    ...
    @objc public var mEnabled = 1
    @objc public var mRepeat = 0
    @objc public var mYear = 2000
    @objc public var mMonth = 1
    @objc public var mDay = 1
    @objc public var mHour = 0
    @objc public var mMinute = 0
    @objc public var mTag = ""

    required public init(_ data: Data? = nil, _ byteOrder: ByteOrder = .BIG_ENDIAN) {
        super.init(data, byteOrder)
    }

    public init(_ enabled: Int = 1, _ repeat: Int = 0, _ year: Int = 2000, _ month: Int = 1, _ day: Int = 1,
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleAlarm{
