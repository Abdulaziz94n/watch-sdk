...
/// 比赛记录团队信息
open class BleMatchRecordTeam: BleReadable {
    ...
    public var mRefereeRoles = [String]()
    
    /// 主队球员信息（player info data），每个球队最多25人
    public var mHomePlayers = [BleMatchRecordPlayer]()
    /// 客队球员信息（player info data），每个球队最多25人
    public var mGuestPlayers = [BleMatchRecordPlayer]()
