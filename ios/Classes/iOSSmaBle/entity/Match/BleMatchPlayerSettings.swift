...
/// 比赛球员设置
open class BleMatchPlayerSettings: BleWritable {

    /// 比赛设置类型主队和客队
    public var mMatchSetType = MatchSetType.HOME_TEAM_PLAYER_LIST.rawValue
    /// 球员列表（最多25）
    public var mPlayerList = [BleMatchPlayer]()
