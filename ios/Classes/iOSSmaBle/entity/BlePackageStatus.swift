...
open class BlePackageStatus: BleReadable {

    /// 字库状态信息 0:有效, 1无效
    public var mFontPackageStatus: Int = 0
    /// UI状态信息 0:有效, 1无效
    public var mUIPackageStatus: Int = 0
    /// 语言包状态信息 0:有效, 1无效
    public var mLanguagePackageStatus: Int = 0
    /// 调试数据, 父类有了mData变量, 为了区分, 这里修改下
    public var mByte: Data?
