...
open class BleSedentarinessSettings: BleWritable {
    ...
    @objc public var mRepeat: Int = 127 //Monday - Sunday (Arbitrary choice)
    @objc public var mStartHour: Int = 8
    @objc public var mStartMinute: Int = 0
    @objc public var mEndHour: Int = 18
    @objc public var mEndMinute: Int = 0
    @objc public var mInterval: Int = 120 // 分钟数
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleSedentarinessSettings{
