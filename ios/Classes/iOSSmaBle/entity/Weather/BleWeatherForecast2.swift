...
open class BleWeatherForecast2: BleWritable {
    
    public var mTime: Int = 0 // 时间戳，秒数
    public var mCityName: String = "" //城市名
    public var mWeather1: BleWeather2?
    public var mWeather2: BleWeather2?
    public var mWeather3: BleWeather2?
    public var mWeather4: BleWeather2?
    public var mWeather5: BleWeather2?
    public var mWeather6: BleWeather2?
    public var mWeather7: BleWeather2?
    ...
    public init(time: Int, cityName: String, weather1: BleWeather2? = nil, weather2: BleWeather2? = nil,
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) -> BleWeatherForecast2 {
