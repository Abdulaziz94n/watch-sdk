...
open class BleWeatherForecast: BleWritable {
    ...
    public var mWeather1: BleWeather? = nil
    public var mWeather2: BleWeather? = nil
    public var mWeather3: BleWeather? = nil

    required public init(_ data: Data? = nil, _ byteOrder: ByteOrder = .BIG_ENDIAN) {
        super.init(data, byteOrder)
    }

    public init(time: Int, weather1: BleWeather? = nil, weather2: BleWeather? = nil,
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleWeatherForecast{
