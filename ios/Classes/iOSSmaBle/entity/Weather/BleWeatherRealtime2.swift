...
open class BleWeatherRealtime2: BleWritable {

    /// 时间戳，秒数/
    public var mTime: Int = 0
    /// 城市名
    public var mCityName: String = ""
    public var mWeather: BleWeather2?
    ...
    public init(time: Int, cityName: String = "", weather: BleWeather2? = nil) {
        super.init()
        mTime = time
        mCityName = cityName
        mWeather = weather
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleWeatherRealtime2{
