...
open class BleWeatherRealtime: BleWritable {
    ...
    public var mWeather: BleWeather? = nil

    required public init(_ data: Data? = nil, _ byteOrder: ByteOrder = .BIG_ENDIAN) {
        super.init(data, byteOrder)
    }

    public init(time: Int, weather: BleWeather? = nil) {
        super.init()
        mTime = time
        mWeather = weather
    }
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleWeatherRealtime{
