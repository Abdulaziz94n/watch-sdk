...
open class BleTime: BleWritable {
    ...
    public var mYear = 2000
    public var mMonth = 1
    public var mDay = 1
    public var mHour = 1
    public var mMinute = 1
    public var mSecond = 1

    required public init(_ data: Data? = nil, _ byteOrder: ByteOrder = .BIG_ENDIAN) {
        super.init(data, byteOrder)
    }

    public init(_ year: Int, _ month: Int, _ day: Int, _ hour: Int, _ minute: Int, _ second: Int) {
        super.init()
        mYear = year
        mMonth = month
        mDay = day
    ...
    public static func utc() -> BleTime {
    ...
    public static func local() -> BleTime {
    ...
    public static func ofLocal(_ timeIntervalSince1970: Int) -> BleTime {
