...
open class BleTimeRange: BleWritable {
    ...
    @objc public var mEnabled: Int = 0 // 0 关闭, 1 开启
    @objc public var mStartHour: Int = 0
    @objc public var mStartMinute: Int = 0
    @objc public var mEndHour: Int = 0
    ...
    public init(_ enabled: Int, _ startHour: Int, _ startMinute: Int, _ endHour: Int, _ endMinute: Int) {
        super.init()
        mEnabled = enabled
