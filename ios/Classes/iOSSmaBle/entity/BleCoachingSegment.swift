...
open class BleCoachingSegment: BleWritable {
    static let LENGTH_NAME = 15

    public var mCompletionCondition = 0
    public var mName = "" // 名称
    public var mActivity = 0 // 运动
    public var mStage = 0
    ...
    public var mCompletionValue = 0

    // 只有在CompletionCondition为DURATION_IN_HR_ZONE时有意义
    public var mHrZone = 0
    ...
    public init(_ completionCondition: Int, _ name: String, _ activity: Int, _ state: Int,
