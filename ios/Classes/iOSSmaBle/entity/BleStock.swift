...
open class BleStock: BleIdObject {
    ...
    public var mColorType : Int = 0 //颜色类型[COLOR_TYPE_0] [COLOR_TYPE_0]
    public var mStockCode : String = ""//股票代码
    public var mSharePrice : Float = 0.0  // 股价
    public var mNetChangePoint : Float = 0.0  // 涨跌点数
    public var mNetChangePercent : Float = 0.0  // 涨跌百分比
    public var mMarketCapitalization : Float = 0.0  // 市值

    required public init(_ data: Data? = nil, _ byteOrder: ByteOrder = .BIG_ENDIAN) {
        super.init(data, byteOrder)
    }

    public init( _ companyName: String = "",_ sharePrice:Float = 0.0,_ netChangePoint:Float = 0.0,_ netChangePercent:Float = 0.0,_ marketCapitalization:Float = 0.0) {
        super.init()
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleStock{
