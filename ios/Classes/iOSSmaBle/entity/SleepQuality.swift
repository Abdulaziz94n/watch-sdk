 ...
 * 然后将这些数据回传给设备
 */
open class BleSleepQuality: BleWritable {
    ...
    public var mLight: Int = 0 // 分钟数  浅睡
    public var mDeep: Int = 0  // 分钟数  深睡
    public var mTotal: Int = 0 // 分钟数  总睡眠时间
    ...
    public init(_ light: Int, _ deep: Int, _ total: Int) {
        super.init()
        mLight = light
        mDeep = deep
        mTotal = total
