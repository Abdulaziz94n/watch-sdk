...
open class BleNoDisturbSettings: BleWritable {
    ...
    @objc public var mBleTimeRange1 = BleTimeRange()
    @objc public var mBleTimeRange2 = BleTimeRange()
    @objc public var mBleTimeRange3 = BleTimeRange()
