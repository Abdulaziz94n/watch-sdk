 ...
 */
open class BleCoaching: BleIdObject {
    ...
    public var mDescription = ""
    public var mRepeat = 0 // 重复次数1~255
    private var mSegmentsCount: Int {
        mSegments.count
    }
    public var mSegments = [BleCoachingSegment]()
    ...
    public init(_ title: String, _ description: String, _ `repeat`: Int, _ segments: [BleCoachingSegment]) {
        super.init()
        mTitle = title
