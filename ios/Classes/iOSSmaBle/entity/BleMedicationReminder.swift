...
/// 吃药提醒 类型, 片剂, 胶囊, 滴
public enum BleMedicationType: Int {
    /// 片剂 tablet
    case TYPE_TABLET = 0
    /// 胶囊 capsule
    case TYPE_CAPSULE = 1
    ...
    case TYPE_SPRAY = 4
    /// Solution
    case TYPE_SOLUTION = 5
    /// Injectable
    case TYPE_INJECTABLE = 6
}

/// 吃药提醒 单位, 片剂, 胶囊, 滴
public enum BleMedicationUNIT: Int {
    /// 毫克 milligram
    ...
    case UNIT_PIECE = 5
    /// 国际单位 international
    case UNIT_INTERNATIONAL = 6
    /// 毫居里 millicurie
    case UNIT_MILLICURIE = 7
    /// 毫当量 milliequivalent
    case UNIT_MILLIEQUIVALENT = 8
}


/// 吃药提醒
open class BleMedicationReminder: BleIdObject {
    
    public var mType: Int = 0 //药物类型, 取值参考 BleMedicationType 枚举
    public var mUnit: Int = 0 //药物单位，片、粒等 取值参考 BleMedicationUNIT 枚举
    public var mDosage: Int = 0 //药物剂量根据药物单位来定
    public var mRepeat: Int = 0 //重复提醒位Bit 0:6分别代表周一到周日
    public var mRemindTimes: Int = 0//提醒的次数
    public var mRemindTime1: BleHmTime = BleHmTime()//第1次提醒时间
    public var mRemindTime2: BleHmTime = BleHmTime()//第2次提醒时间
    public var mRemindTime3: BleHmTime = BleHmTime()//第3次提醒时间
    public var mRemindTime4: BleHmTime = BleHmTime()//第4次提醒时间
    public var mRemindTime5: BleHmTime = BleHmTime()//第5次提醒时间
    public var mRemindTime6: BleHmTime = BleHmTime()//第6次提醒时间
    public var mStartYear: Int = 0 //提醒开始日期
    public var mStartMonth: Int = 0
    public var mStartDay: Int = 0
    public var mEndYear: Int = 0 //结束开始日期
    public var mEndMonth: Int = 0
    public var mEndDay: Int = 0
    public var mName: String = "" //药物名称，UTF-8编码
    public var mLabel: String = "" //药物说明标签(UTF8编码)
    ...
    override func decode() {
        ...
        mStartYear = Int(readUInt8()) + 2000
        mStartMonth = Int(readUInt8())
        mStartDay = Int(readUInt8())
        mEndYear = Int(readUInt8()) + 2000
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleMedicationReminder{
