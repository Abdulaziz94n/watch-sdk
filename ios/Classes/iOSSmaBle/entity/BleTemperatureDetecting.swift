...
open class BleTemperatureDetecting: BleWritable {
    ...
    public var mInterval: Int = 0 // 分钟数，发送时除以5
    ...
    public func dictionaryToObjct(_ dic:[String:Any]) ->BleTemperatureDetecting{
