...
open class BleAlipaySettings: BleWritable {
    
    public var mAlipayVersion: Int = 0  // 支付宝版本号
    public var isActivate: Int = 0      // 支付宝激活状态? 0:未激活  1:已激活
    public var mAddress: Data = Data()  // mac地址
