 ...
 * @see -isAvailableForUpgradeOfImages:checkingImageVersion:usingStrictMechanism:inVPMode:withActiveVPID:returnError:
 */
 ...
 * Check the images and returns a boolean value that indicates if those images is valid to be ugprade to device.
 *
 * @see -isAvailableForUpgradeOfImagesForPrimaryBud:imagesForSecondaryBud:checkingImageVersion:usingStrictMechanism:inVPMode:withActiveVPID:returnError:
 */
